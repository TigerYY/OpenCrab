# OpenCarb Phase 2 执行 Backlog

## 1. 文档目的

本文为 Phase 2 全量开发的可执行看板：冻结 API/数据契约、迁移计划与任务拆解，对齐 [OpenCarb-Phase2-PRD](OpenCarb-Phase2-PRD.md) 退出条件与五条主线（审批、技能、作业、可观测、PR Review）。
